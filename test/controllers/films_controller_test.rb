...
class FilmsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create film" do
    assert_difference("Film.count") do
      post films_url, params: { film: { director: @film.director, genre: @film.genre, name: @film.name } }
    end
  ...
  test "should update film" do
    patch film_url(@film), params: { film: { director: @film.director, genre: @film.genre, name: @film.name } }
